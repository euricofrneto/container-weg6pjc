...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-weg6pjc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-weg6pjc.containers.anotherwebservice.com/
...
```
git clone git@github.com:euricofrneto/container-weg6pjc.git
cd container-weg6pjc
```
...
```
docker attach container-weg6pjc
```
